...
/**
  ...
  */
abstract class InputStage[Out <: PipelineItem : ClassTag : Manifest : FromRecord](stageAttributes: StageAttributes = StageAttributes()) extends PipelineObject[NoType, Out](stageAttributes) {
