...
class MongoOutputStageTest extends FunSuite{
  ...
  test("") {
    val pipeline = new PipelineBuilder()
      ...
      .append(new MongoOutputStage[StringType]("mongodb://localhost:27017", "db", "collection"))
      .build()
